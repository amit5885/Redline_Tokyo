      ...
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 group cursor-pointer">
          ...
          <div className="flex flex-col leading-none">
            <span className="text-2xl font-bold font-['Syncopate'] tracking-tighter">REDLINE</span>
            <span className="text-xs tracking-[0.3em] text-gray-400 group-hover:text-white transition-colors">TOKYO</span>
          </div>
        </div>
        ...
        <div className="hidden md:flex items-center gap-10">
          {navLinks.map((link) => (
            ...
            >
              {link.name}
              <span className="absolute bottom-0 left-0 w-full h-[1px] bg-[#FF003C] transform -translate-x-full group-hover:translate-x-0 transition-transform duration-300"></span>
            </a>
          ))}
