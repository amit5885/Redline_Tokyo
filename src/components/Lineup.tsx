...
import transAm from "../assets/trans_am_2000.avif";
import crabSonoshee from "../assets/futurestic-car.avif";
import speedMaster from "../assets/exotic-car.avif";
            ...
            <div key={index} className="group relative cursor-pointer">
              <div className="relative h-[400px] overflow-hidden border border-white/10">
                ...
                <div className="absolute inset-0 bg-[#FF003C]/80 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300 z-20 flex flex-col justify-center p-8">
                  <h4 className="font-['Syncopate'] text-2xl font-bold text-black mb-2">
                    {racer.vehicle}
                  </h4>
                ...
                <div className="absolute bottom-0 left-0 z-10 p-6 group-hover:opacity-0 transition-opacity">
                  <h3 className="text-3xl font-bold italic uppercase">
                    {racer.name}
                  </h3>
                  <p className="text-[#FF003C] text-sm font-bold tracking-widest">
                    {racer.vehicle}
                  </p>
                </div>
              </div>
